...
{
    internal class t_itemContainer: BaseContainer
    {
        private string TableFile = typeof(t_item).Name;
        List<t_item> TableList = new List<t_item>();
        Dictionary<int, t_item> TableMap = new Dictionary<int, t_item>();
